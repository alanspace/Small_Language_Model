...
This work originated from a foundational implementation developed as part of the Programming Techniques II (DA2005) course. While the core k-gram model implementation was completed within that coursework context, the present paper represents a significant independent research extension that goes substantially beyond course requirements.

Specifically, this paper contributes: (1) rigorous mathematical formalization with formal complexity proofs, (2) comprehensive algorithmic analysis not covered in the original course material, (3) extensive experimental validation across multiple corpora, (4) thorough literature review connecting classical and modern approaches, and (5) research-level exposition suitable for academic publication.

The transition from a course programming assignment to a research-quality paper demonstrates the ability to identify interesting problems within structured contexts and pursue them to research depth independently—a critical skill for doctoral research. I am grateful to the course instructors for providing the foundational framework that motivated this deeper investigation into statistical language modeling and systems-level optimization.
